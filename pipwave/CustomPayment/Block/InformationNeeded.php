...
{	
	...
	function set_data()
	{
		...
		$this->notificationUrl = 'https://d6899fa6.ngrok.io/magento2-develop/magento2-develop/notification/notification/index';
		...
		*/
		...
		//ship address
		$shipAddress1 = implode(' ', $order->getShippingAddress()->getStreet(1));
		
		if ($order->getShippingAddress()->getStreet(2)==null) {
			$shipAddress2 = '';
			
		} else {
			$shipAddress2 = implode(' ', $order->getShippingAddress()->getStreet(2));
		}
		
		$shipAddress2 = implode(' ', $order->getShippingAddress()->getStreet(2));
		
		//bill address
		$billAddress1 = implode(' ', $order->getBillingAddress()->getStreet(1));
		
		if ($order->getBillingAddress()->getStreet(2)==null) {
			$billAddress2 = '';
			
		} else {
			$billAddress2 = implode(' ', $order->getBillingAddress()->getStreet(2));
		}
		...
		$this->data = array(
			...
			'shipping_info' => //$this->cart->getQuote()->getShippingAddress()->getData(),
				array(
				'name' =>$order->getShippingAddress()->getFirstname().' '.$order->getShippingAddress()->getLaststname(),
